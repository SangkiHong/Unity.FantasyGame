...
namespace Sangki.Quest
{
    ...
    public class Task : ScriptableObject
    {
        ...
        public delegate void SuccessChangedHandler(Task task, int currentSucess, int prevSuccess);
        #endregion
        [SerializeField]
        ...
        public string Decsription => decsription;
        ...
        public void Start()
        {
            ...
            if (initialSuccessValue) CurrentSuccess = initialSuccessValue.GetValue(this);
        }
